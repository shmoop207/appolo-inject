...
function inject(inject) {
    return function (target, propertyKey, descriptor) {
        if (!propertyKey || typeof descriptor == "number") {
            ...
            (0, decorators_1.addDefinitionProperty)("inject", [util_1.Util.getClassNameOrId(inject)], true).apply(this, arguments);
        }
    };
}
...
function injectParam(name) {
    return function (target, propertyKey, index) {
        ...
        if (!propertyKey) {
            ...
            (0, decorators_1.addDefinition)("args", [{ ref: util_1.Util.getClassNameOrId(name) || args[index] }, index], target);
            return;
        }
