...
function addDefinition(name, args, type) {
    let injectDef = Reflect.getOwnMetadata(exports.InjectDefinitionsSymbol, type) || _.cloneDeep(Reflect.getMetadata(exports.InjectDefinitionsSymbol, type));
    if (!injectDef) {
        injectDef = [];
        Reflect.defineMetadata(exports.InjectDefinitionsSymbol, injectDef, type);
    }
